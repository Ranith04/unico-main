            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white/90 text-sm sm:text-base">support@unico-international.com</span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-white/80 flex-shrink-0" />
                  <span className="text-white/90 text-sm sm:text-base">08041489479</span>
                </div>
                <div className="flex items-center gap-3">
                  <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-white/80 flex-shrink-0" />
                  <span className="text-white/90 text-sm sm:text-base">17/152/5 Neeladri nagara, Doddathogur (v), BANGALORE, KARNATAKA -560100</span>
                </div>
              </div>
            </div>
          </motion.div>
